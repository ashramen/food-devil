...
interface BottomAppBarProps extends PropsFromRedux, RouteComponentProps {
    page: string;
};

interface BottomAppBarStates {
    open: boolean;
};
    ...
    return (
        <div>
            ...
            >
                ...
                <MenuItem onClick={props.handleExportClick} disableRipple>
                    Export Data
                </MenuItem>
...
export class BottomAppBar extends React.Component<BottomAppBarProps, BottomAppBarStates> {
    constructor(props: BottomAppBarProps) {
        super(props);
        this.state = {
            open: false
        };
...
export default connector(withRouter(BottomAppBar));